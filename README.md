## Introduction
This project is focused on deploying a real-time game application using Amazon EKS(Elastic Kubernetes Service.) The primary goal is to create a scalable and efficient environment where the game can handle multiple players and provide a seamless gaming experience.
